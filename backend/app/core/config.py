...
class Settings(BaseSettings):
    ...
    model_dir: Path = Field(default=Path("backend/.cache/models/birefnet"), alias="STICKIFY_MODEL_DIR")
    model_name: str = Field(default="onnx-community/BiRefNet_lite-ONNX", alias="STICKIFY_MODEL_NAME")
